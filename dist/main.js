...
class $882b6d93070905b3$var$KeyboardShortcutInlineTool {
    static get isInline() {
        return true;
    }
    static get shortcut() {
...
`;
    ...
    wrap(range) {
        ...
        kbd.classList.add($882b6d93070905b3$var$KeyboardShortcutInlineTool.CSS);
    ...
    unwrap(range) {
        const selectedText = range.extractContents();
        const keyboardTag = this.api.selection.findParentTag("KBD", $882b6d93070905b3$var$KeyboardShortcutInlineTool.CSS);
        if (keyboardTag) {
            keyboardTag.remove();
    ...
    checkState(selection) {
        const tag = this.api.selection.findParentTag("KBD", $882b6d93070905b3$var$KeyboardShortcutInlineTool.CSS);
        this.state = !!tag;
        if (this.button) this.button.classList.toggle(this.api.styles.inlineToolButtonActive, this.state);
        return this.state;
    }
}
var $882b6d93070905b3$export$2e2bcd8739ae039 = $882b6d93070905b3$var$KeyboardShortcutInlineTool;
